...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('DOCTOR', 'PATIENT', 'ADMIN', 'SUPER_ADMIN');
...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_appoitnmentId_key" ON "Payment"("appoitnmentId");
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_appoitnmentId_fkey" FOREIGN KEY ("appoitnmentId") REFERENCES "appointments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
